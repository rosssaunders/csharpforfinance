...
namespace Library.Excel
{
    ...
    {
        private readonly ExcelDriver _excel;

        public ExcelMechanisms(string file)
        { 
            _excel = new ExcelDriver(file);
        }
        ...
        public void printOneExcel<T>(Vector<T> x, Vector<T> functionResult, string title, string horizontal, string vertical, string legend)
        {
            ...
            _excel.CreateChart(x, legendList, functionResultList, title, horizontal, vertical);
        }
        ...
        {
            _excel.CreateChart(x, labels, functionResult, title, horizontal, vertical);
        }
        ...
        public void printMatrixInExcel<T>(NumericMatrix<T> matrix, Vector<T> xarr, Vector<T> yarr, string SheetName)
        {
            ...
            _excel.AddMatrix(SheetName, matrix, rowlabels, columnlabels);
        }
        ...
        public void printLatticeInExcel(Lattice<double> lattice, Vector<double> xarr, string SheetName)
        {
            ...
            _excel.AddLattice(SheetName, lattice, rowlabels);
        }
        ...
        */
            ...
            _excel.AddMatrix(SheetName, matrix.mat, rowlabels, columnlabels);
        }
        ...
        public void printTensorInExcel<T>(Tensor<T> tensor)
        {
            ...
            {
                name = i.ToString();
                _excel.AddMatrix(name, tensor[i], rowlabels, columnlabels);
            }
        }
        ...
        public void printTensorInExcel<T>(Tensor<T> tensor, Vector<T> xarr, Vector<T> yarr, string SheetName)
        {
            ...
            for (int i = tensor.MaxThirdIndex; i >= tensor.MinThirdIndex; i--)
            {
                ...
                _excel.AddMatrix(tmp, tensor[i], rowlabels, columnlabels);
            }
        }
